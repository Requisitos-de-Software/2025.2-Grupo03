...
| <a id="PT14"></a>PT14 | [RF31](https://requisitos-de-software.github.io/2025.2-Grupo03/Elicitacao/requisitos_elicitados/#RF31) | Os materiais devem estar postados em tópicos de conteúdos separados na disciplina  | O protótipo de [Seleção de Sistemas](../arquivos/output-2.pdf) demonstra como o usuário, a partir da tela "Sistemas", pode expandir um menu ("Sistemas relacionados") para visualizar e acessar outras plataformas, como Sigaa, Teams e Aprender.  |
| <a id="PT15"></a>PT15 | [RF33](https://requisitos-de-software.github.io/2025.2-Grupo03/Elicitacao/requisitos_elicitados/#RF33) | A interface deve exibir a lista de materiais, tópicos ou conteúdos da disciplina. | O protótipo de [Listagem de Materiais](../arquivos/output-1.pdf) demonstra como o sistema exibe os diferentes tópicos de estudo da disciplina (ex: Modelagem de Dados, Controle de Acesso) em formato de lista, permitindo a navegação. |
