...
- Ambiente: realizadas presencialmente em locais escolhidos pelo usuário (Sala do professor) para maior conforto e segurança.
...
| RF52 | O sistema deve permitir que o indivíduo escolha o canal de notificação desejado.                              | [Entrevista](https://requisitos-de-software.github.io/2025.2-Grupo03/Elicitacao/entrevista/) | Não |
...
| RNF12 | O sistema deve seguir padrões de acessibilidade para garantir usabilidade a todos os indivíduos. | [Entrevista](https://requisitos-de-software.github.io/2025.2-Grupo03/Elicitacao/entrevista/) | Não |
