...
|-------|-----------|
| [Arthur Guilherme](https://github.com/ArthurGuilher62) | Participou da priorização prensencial (Observador). |
| [Tiago Lemes](https://github.com/TiagoTeixeira-2005) | Participou da priorização prensencial (Redator) e fez a documentação do arquivo. |
| [Vilmar José](https://github.com/VilmarFagundes)| Participou da priorização prensencial (Entrevistador). |
...
<div align="center"><strong>Tabela 2: Tabela de Priotização - First Thing First</strong></div>
...
| RF15 | Acompanhamento Real (Real) | O sistema deve enviar notificações para lembrar o indivíduo de revisar conteúdos passados | 8 | 6 | 22 | 2,1 | 1 | 0,6 | 1 | 0,6 | 2,4 |
...
| RF17 | Acompanhamento Real (Real) | O sistema deve enviar lembretes para o indivíduo sobre datas de entregas de atividades | 9 | 9 | 27 | 2,6 | 2 | 1,1 | 2 | 1,2 | 1,5 |
...
| RF12 | Acompanhamento Real (Real) | A interface deve exibir a média do indivíduo após a atividade | 9 | 9 | 27 | 2,6 | 3 | 1,7 | 2 | 1,2 | 1,1 |
...
| RF14 | Acompanhamento Real (Real) | O indivíduo deve marcar os tópicos da disciplina no qual ele sente mais facilidade | 7 | 5 | 19 | 1,8 | 3 | 1,7 | 2 | 1,2 | 0,8 |
...
| RF19 | Acompanhamento Real (Real) | O sistema deve pedir ao indivíduo a melhor forma de caminho de notificação | 5 | 3 | 13 | 1,2 | 2 | 1,1 | 2 | 1,2 | 0,7 |
...
| RF21 | Acompanhamento Real (Real) | O indivíduo escolhe quando ele recebe a notificação de proximidade da data de entrega de atividade (ex: 24h antes, 1 semana antes, etc) | 6 | 6 | 18 | 1,7 | 3 | 1,7 | 3 | 1,7 | 0,7 |
| RF39 | Interface Animado (MInA) | O assistente virtual deve ser visível na interface | 7 | 7 | 21 | 2,0 | 4 | 2,3 | 4 | 2,3 | 0,6 |
| RF47 | Projeto de Monitoria Estudantil (PMon) | O assistente virtual deve fornecer dados relevantes ao indivíduo (progressão do aluno) | 7 | 7 | 21 | 2,0 | 4 | 2,3 | 4 | 2,3 | 0,6 |
...
| RF13 | Acompanhamento Real (Real) | O indivíduo deve escolher o tempo em que deseja receber alertas sobre atividades atrasadas | 5 | 3 | 13 | 1,2 | 4 | 2,3 | 4 | 2,3 | 0,4 |
...
| RF40 | Interface Animado (MInA) | O assistente virtual deve ser customizável pelo indivíduo | 2 | 2 | 6 | 0,6 | 3 | 1,7 | 2 | 1,2 | 0,2 |
