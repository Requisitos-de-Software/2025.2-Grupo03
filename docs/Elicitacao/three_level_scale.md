...
|-------|-----------|
| [Felipe Guimarães](https://github.com/felipegf1) | Participou da priorização prensencial. |
| [Tiago Lemes](https://github.com/TiagoTeixeira-2005) | Fez a documentação do arquivo. |
| [Vilmar José](https://github.com/VilmarFagundes)| Participou da priorização prensencial. |
<div align="center"><strong>Autoria de <a href="https://github.com/TiagoTeixeira-2005">Tiago Lemes</a></strong></div>

## Metodologia
A atividade de tabulação e priorização dos requisitos foi conduzida presencialmente com os integrantes Felipe Guimarães e Vilmar José, juntamente com Mariana Schumann, usuária real que participou validando os requisitos. Nessa etapa, foi utilizada a escala Three Level Scale (Baixa, Média e Alta).

## Tabela de Priorização
A Tabela 2 apresenta a priorização dos requisitos, organizada em ordem decrescente de prioridade.

<div align="center"><strong>Tabela 2: Tabela de Priotização - Three Level Scale</strong></div>

| ID   | Categoria | Descrição | Prioridade |
|------|-----------|-----------|------------|
| RF01 | Acadêmico (Maior)                | O sistema deve identificar cada indivíduo (aluno, monitor, professor, coordenador, diretor, administrador)        | ALTA       |
| RF02 | Académico (Maior)                | O sistema deve ter perfil individual                                                                              | ALTA       |
| RF03 | Acadêmico (Maior)                | Deve mapear conceitos relacionados ao conteúdo, respeitando a hierarquia da Teoria da Aprendizagem Significativa (TAS). | ALTA       |
...
| RF26 | Banco de Questões (BDQ)          | Deve promover a interação dos alunos com as questões, avaliando seu conhecimento informativo e formativo.          | ALTA       |
| RF28 | Banco de Questões (BDQ)          | O SAE deve fornecer assistência para alunos neste módulo.                                                         | ALTA       |
| RF29 | Banco de Questões (BDQ)          | O sistema deve conter um banco de questões geradas pelo professor                                                 | ALTA       |
| RF31 | Conteúdo (SRC)                   | O sistema deve direcionar cada aluno a materiais adequados à sua situação cognitiva e preferências.               | ALTA       |
...
| RF48 | Projeto de Monitoria Estudantil (PMon) | Deve disponibilizar informações sobre horários e locais de monitoria.                                          | BAIXA      |
...
|--------|------|-----------|-----------|---------|
| 1.0    | 29/09/2025 | Criação do documento do Three Level Scale | [Tiago Lemes](https://github.com/TiagoTeixeira-2005) | |
